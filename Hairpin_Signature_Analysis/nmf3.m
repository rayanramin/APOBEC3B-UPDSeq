function w=nmf3(v,h,verbose)
%
% STEERED NMF
% specifying an h matrix
%
% based on:
%
% STANDARD NMF 
...
%
% h       : r x M NMF factor    (e.g. from a previous run)
%
...
for i=1:niter
    ...
    % divergence-reducing NMF iterations (for w only)
